namespace Writers.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Writers.DAL.WritersContext>
    {
        ...
        protected override void Seed(Writers.DAL.WritersContext context)
        {
            ...
            //        Century = "16th-17th", Country = "England", Genres = new List<Genre>() },
            ...
            //        Occupation = "Novelist, interpreter, philosopher, military engineer", Century = "19th", Country = "Russian Empire", Genres = new List<Genre>() },
            ...
            //        Occupation = "Novelist", Century = "19th", Country = "England", Genres = new List<Genre>() },
            ...
            //        Occupation = "Novelist, playwright, physician", Century = "19th-20th", Country = "Russian Empire", Genres = new List<Genre>()},
            ...
            //        Occupation = "Novelist", Century = "19th", Country = "France", Genres = new List<Genre>()},
            ...
            //        Occupation = "Novelist, poet, journalist, drawer", Century = "19th", Country = "France", Genres = new List<Genre>()},
            ...
            //        Occupation = "Novelist, poet, journalist", Century = "19th-20th", Country = "England", Genres = new List<Genre>()},
            ...
            //        Occupation = "Novelist", Century = "19th-20th", Country = "Germany", Genres = new List<Genre>()},
            ...
            //        Occupation = "Novelist, poet", Century = "19th-20th", Country = "England", Genres = new List<Genre>()},
            ...
            //        Occupation = "Novelist", Century = "18th-19th", Country = "England", Genres = new List<Genre>()}
            //};

            //persons.ForEach(p => context.Persons.AddOrUpdate(pers => pers.FullName, p));
            //context.SaveChanges();

            var images = new List<Images>()
            {
                new Images {ImagePath = "/Content/Images/Shakespeare/Shakespeare.jpg"},
                new Images {ImagePath = "/Content/Images/Dostoevsky/Dostoevsky.jpg"},
                new Images {ImagePath = "/Content/Images/Dickens/Dickens.jpg"},
                new Images {ImagePath = "/Content/Images/Chekhov/Chekhov.jpg"},
                new Images {ImagePath = "/Content/Images/Flaubert/Flaubert.jpg"},
                new Images {ImagePath = "/Content/Images/Hugo/Hugo.jpg"},
                new Images {ImagePath = "/Content/Images/Kipling/Kipling.jpg"},
                new Images {ImagePath = "/Content/Images/Remarque/Remarque.jpeg"},
                new Images {ImagePath = "/Content/Images/Aldington/Aldington.jpg"},
                new Images {ImagePath = "/Content/Images/Austen/Austen.jpg"},
                new Images {ImagePath = "/Content/Images/Shakespeare/WilliamShakespeare.png"},
                new Images {ImagePath = "/Content/Images/Dostoevsky/Dostoevsky.png"},
            };

            images.ForEach(i => context.Images.AddOrUpdate(img => img.ImagePath, i));
            context.SaveChanges();
            ...
            //works.ForEach(w => context.Works.AddOrUpdate(work => work.Title, w));
            //context.SaveChanges();
            ...
            //genres.ForEach(g => context.Genres.AddOrUpdate(genre => genre.Title, g));
            //context.SaveChanges();

            //AddInitialImages(context, persons, images);

            AddOrUpdateImage(context, "William Shakespeare", "/Content/Images/Shakespeare/WilliamShakespeare.png");
            AddOrUpdateImage(context, "Fyodor Dostoevsky", "/Content/Images/Dostoevsky/Dostoevsky.png");

            AddOrUpdateGenre(context, "Fyodor Dostoevsky", "Novel");
            AddOrUpdateGenre(context, "Fyodor Dostoevsky", "Novella");
        }

        public void AddOrUpdateImage(WritersContext context, string personFullName, string imagePath)
        {
            var person = context.Persons.SingleOrDefault(p => p.FullName == personFullName);
            var image = person.Images.SingleOrDefault(img => img.ImagePath == imagePath);
            if (image == null)
                person.Images.Add(context.Images.SingleOrDefault(img => img.ImagePath == imagePath));
        }
        ...
        //public void AddInitialImages(WritersContext context, List<Person> persons, List<Images> images)
        //{
        //    for(int i = 0; i < persons.Count; i++)
        //    {
        //        AddOrUpdateImage(context, persons[i].FullName, images[i].ImagePath);
        //    }
        //}
    }
}
